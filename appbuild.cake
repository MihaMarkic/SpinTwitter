...
var dokreg = Argument<string>("dokreg", "dokreg.rthand.com:443");
var setVersion = Argument<string>("buildVersion", null);

var rootDirectory = Directory("./Source");
var solution = rootDirectory + File("SpinTwitter.sln");
var appDirectory = rootDirectory + Directory("SpinTwitter"); 
var appProject = appDirectory + File("SpinTwitter.csproj");
...
Task("BuildImage")
	.Does(() =>{
		...
		BuildAndPush("spin-twitter", new []{ "latest", version });
	});
...
Task("Default")
    .Does(() => { 
		Information("SpinNotifications build process targets");
